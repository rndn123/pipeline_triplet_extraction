...
df_train = pd.read_csv("../Preprocessed_Dataset/Training_Triplets_A.csv")
df_val = pd.read_csv("../Preprocessed_Dataset/Trial_Triplets_A.csv")
...
torch.save(model.state_dict(), 'scibert_triplets_A.pt')
...
# Display the table.
df_stats.to_csv("Training_stats_A.csv")
...
df_test.to_csv("test_results_A.csv", index = None)
