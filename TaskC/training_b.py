...
df_train = pd.read_csv("../Preprocessed_Dataset/Training_Triplets_B.csv")
df_val = pd.read_csv("../Preprocessed_Dataset/Trial_Triplets_B.csv")
df_test = pd.read_csv('../Preprocessed_Dataset/Test_Triplets_B.csv')
...
torch.save(model.state_dict(), 'scibert_triplets_B.pt')
...
# Display the table.
df_stats.to_csv("Training_stats_B.csv")

model.load_state_dict(torch.load('scibert_triplets_B.pt'))
...
df_test.to_csv("test_results_B.csv", index = None)
