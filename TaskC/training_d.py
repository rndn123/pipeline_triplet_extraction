...
df_train = pd.read_csv("../Preprocessed_Dataset/Training_Triplets_D.csv")
df_val = pd.read_csv("../Preprocessed_Dataset/Trial_Triplets_D.csv")
df_test = pd.read_csv('../Preprocessed_Dataset/Test_Triplets_D.csv')
...
torch.save(model.state_dict(), 'scibert_triplets_D.pt')
...
# Display the table.
df_stats.to_csv("Training_stats_D.csv")

model.load_state_dict(torch.load('scibert_triplets_D.pt'))
...
df_test.to_csv("test_results_D.csv", index = None)
