...
df_train = pd.read_csv("../Preprocessed_Dataset//NCG_Predicate.csv")
df_val = pd.read_csv("../Preprocessed_Dataset/Test_Predicate.csv")
df_test = pd.read_csv('../Preprocessed_Dataset/Test_Predicate.csv')
...
for epoch_i in range(0, epochs):
    ...
    if best_valid_F1 < F1:
        best_valid_F1 = F1
        torch.save(model.state_dict(), 'predicate_classification.pt')
...
# Display the table.
df_stats.to_csv("Training_stats_2.csv")

model.load_state_dict(torch.load('predicate_classification.pt'))
