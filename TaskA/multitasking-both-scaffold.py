...
df_train = pd.read_csv("../Preprocessed_Dataset/training_data_4.csv")
df_val = pd.read_csv("../Preprocessed_Dataset/trial_data_4.csv")
...
df_section = pd.read_csv("../Preprocessed_Dataset/section_dataset.csv")
df_citation = pd.read_csv("../Preprocessed_Dataset/citation_scaffold.csv")
...
def train(model, config, optimizer, scheduler, criterion1):
  ...
  main_loss, section_loss, citation_loss, total_accuracy = 0, 0, 0, 0
...
def training():
  ...
  # push the model to GPU
  model = model.to(device)
  torch.save(model.state_dict(), 'scibert_256.pt')
  #Save Random Weights
